    ...
    <div className="min-h-screen flex items-center justify-center hero-gradient p-4">
      <div className="w-full max-w-md animate-bounce-in">
        <div className="glass-strong rounded-2xl shadow-2xl p-8">
          ...
          {error && (
            <div className="mb-6 state-error p-4 border-2 rounded-xl flex items-start gap-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-primary py-3.5 text-base font-bold disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:hover:shadow-none"
            >
              {loading ? (
                <>
          ...
          <div className="p-4 glass rounded-xl border-2 border-purple-200 dark:border-purple-700">
            <p className="text-xs text-gray-700 dark:text-gray-300">
              <strong className="text-gray-900 dark:text-white text-sm">How to get your API keys:</strong>
              <br />
              <span className="mt-2 block">
                WooCommerce → Settings → Advanced → REST API → Add key
              </span>
              <span className="mt-2 block text-gradient font-semibold">
